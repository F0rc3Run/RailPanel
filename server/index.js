...
async function route(req, res) {
  ...
  const isPublic = path === '/healthz' || path.startsWith('/sub/');
  ...
  // Anything unrecognised gets the panel shell; the client router decides
  // what to show. Unknown asset requests still 404 above.
  if (req.method === 'GET' && !extname(path)) {
